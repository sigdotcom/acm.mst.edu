...
class TransactionCategoryManager(models.Manager):
    ...
    def get_by_natural_key(self, name):
        ...
        :rtype: products.models.TransactionCategory or None
    ...
    def _create_category(self, name, **kwargs):
        ...
        :rtype: products.models.TransactionCategory
...
class ProductManager(models.Manager):
    ...
    def get_by_natural_key(self, name):
        ...
        :rtype: products.models.Product or None
...
class TransactionManager(models.Manager):
    ...
    def get_by_natural_key(self, stripe_token):
        ...
        :rtype: products.models.Transaction or None.
    ...
    def _create_transaction(self, stripe_token, **kwargs):
        ...
        :rtype: products.models.Transaction
