...
urlpatterns = [
    ...
    url('transactions/(?P<pk>[0-9a-z_-]+)/$', views.TransactionDetail.as_view(), name='transaction-detail'),

    # acm.mst.edu/web-api/product/
    url('product/$', views.ProductList.as_view(), name='product-list'),

    # acm.mst.edu/web-api/product/<pk>/
    url('product/(?P<pk>[0-9a-z_-]+)/$', views.ProductDetail.as_view(), name='product-detail'),

    # acm.mst.edu/web-api/category/
    url('category/$', views.CategoryList.as_view(), name='category-list'),

    # acm.mst.edu/web-api/category/<pk>/
    url('category/(?P<pk>[0-9a-z_-]+)/$', views.CategoryDetail.as_view(), name='category-detail'),
]
